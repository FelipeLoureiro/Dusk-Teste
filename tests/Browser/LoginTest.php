    ...
    public function Login()
    {
        $this->browse(function (Browser $browser) {
            ...
            $browser->on(new FuncoesSun())
                    ->ElementoCheck(LoginTest::ElementosFuncao()['Vendedor']['check'],'fun_adicional');
            ...
            $browser->on(new FuncoesSun())
                ->ElementoCheck(LoginTest::ElementosFuncao()['Vendedor']['check'],'mp_id');
            ...
            $browser->on(new FuncoesSun())
                    ->ElementoCheck(LoginTest::ElementosFuncao()['Vendedor']['check'],'amp_id');
